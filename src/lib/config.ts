export const appName = 'CommerceGuardian OS';
export const appStoreUrl = 'https://apps.shopify.com/commerceguardianos';
export const projectBasePath = '';
export const siteUrl = 'https://commerceguardianos.com';
export const futureDomain = 'commerceguardianos.com';
